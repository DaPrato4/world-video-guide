...
import { FiArrowRight, FiPlayCircle, FiTrash2 } from "react-icons/fi";
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 px-2 py-2 text-xs font-semibold text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded transition-colors"
                        title="Rimuovi video in sospeso"
                      >
                        <FiTrash2 className="w-3 h-3" />
                        <span className="inline">Rimuovi</span>
                      </button>
                    </div>
                  </div>
                </div>
