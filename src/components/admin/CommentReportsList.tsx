  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-[#1a1a1a] border-2 border-dashed border-white/5 rounded-3xl py-24 flex flex-col items-center justify-center text-neutral-500">
        ...
        <motion.div layout className="flex flex-col gap-4">
          <AnimatePresence mode="popLayout">
            {reports.map(r => (
              <motion.div key={r.commentId} layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 8 }} className="bg-neutral-900 p-4 rounded-2xl border border-white/5 flex flex-col gap-3">
