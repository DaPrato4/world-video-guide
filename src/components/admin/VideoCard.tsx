      ...
      <div className="flex flex-col sm:flex-row gap-4 flex-1 min-w-0 w-full group">
        {video.thumbnail && (
          <a
            ...
            className="w-full sm:w-32 aspect-video sm:h-[72px] shrink-0 overflow-hidden rounded-lg bg-neutral-900 border border-white/5 group-hover:border-blue-500/50 transition-colors relative block self-center"
          >
            <img
              src={video.thumbnail}
              alt="Thumbnail"
